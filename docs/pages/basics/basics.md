...
Like many other things in Foundry, right clicking a Test in chat provides many useful options that every user should know about. You can also select individual dice to perform actions on them. 

![Test Context](../../assets/basics/test-context.webp)

### Advancement

Spending XP on Characteristics and Skills is done in a separate window, accessed via the Notes tab. This is also where you can change the base value for Characteristics and Skills.
